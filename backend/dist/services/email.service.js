...
class EmailService {
    static sendTicketEmail(to_1, userName_1, championshipName_1, pdfBuffer_1) {
        return __awaiter(this, arguments, void 0, function* (to, userName, championshipName, pdfBuffer, wonTshirt = false) {
            const mailOptions = {
