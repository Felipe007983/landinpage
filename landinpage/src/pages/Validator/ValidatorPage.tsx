    ...
    return (
        <div className="min-h-screen bg-black text-white pt-24 pb-12 px-6 flex flex-col items-center">
            <div className="w-full max-w-3xl">
                <h1 className="text-3xl font-black uppercase text-center mb-8 text-amber-500 flex items-center justify-center gap-3">
                ...
                <div className="bg-zinc-900 border border-white/10 rounded-2xl p-8 shadow-2xl">
                    ...
                    <form onSubmit={handleManualSubmit} className="flex gap-4">
                        <input
                            ...
                            className="flex-1 bg-zinc-800 border border-zinc-700 text-white rounded-lg px-6 py-4 font-mono text-center tracking-widest focus:outline-none focus:border-amber-500"
                            value={uuid}
                        ...
                        <button
                            ...
                            className="bg-amber-500 hover:bg-amber-400 text-black px-8 rounded-lg font-black uppercase tracking-wider flex items-center justify-center gap-2 transition-all disabled:opacity-50"
                        >
