...
export function ChampionshipsPage() {
    ...
    const handleAction = (c: any, type: 'COMPETITOR' | 'VISITOR') => {
        ...
        const confirmMessage = `Confirmar compra de ingresso como ${type === 'COMPETITOR' ? 'Competidor' : 'Visitante'} por R$ ${type === 'COMPETITOR' ? c.priceComp : c.priceVis}?`;
    ...
    return (
        <div className="min-h-screen bg-black text-white pt-24 pb-12 px-6">
            <div className="container mx-auto">
                <h1 className="text-4xl md:text-5xl font-black text-amber-500 mb-2 uppercase tracking-tight text-center">Campeonatos de Fisiculturismo</h1>
                <p className="text-gray-400 text-center mb-12">Inscreva-se ou compre seu ingresso para os próximos eventos do Zeus Evolution.</p>
            ...
            {selectedChamp && (
                <div className="fixed inset-0 z-[100] bg-black/90 backdrop-blur-sm flex items-center justify-center p-4">
                    <div className="bg-zinc-900 border border-amber-500/30 w-full max-w-2xl rounded-2xl overflow-hidden relative shadow-2xl">
