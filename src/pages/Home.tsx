            ...
            <section className="relative aspect-[3/2] md:aspect-auto md:min-h-screen flex items-center justify-center overflow-hidden">
                <div className="absolute inset-0 z-0">
                    <img
                        ...
                        className="w-full h-full object-contain object-top pt-32 md:pt-20 bg-black"
                    />
                </div>

                <div className="relative z-10 text-center px-4 w-full pt-32 md:pt-20">
                    <motion.h1
                    ...
                    >
                        Onde lendas colidem e a história é reescrita. O palco definitivo para a supremacia absoluta.
                    </motion.p>
