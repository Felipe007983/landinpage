...
export function StandardPage({ title, subtitle, image, video, products, mvv, contacts, color, secondaryColor, history, secondaryVideo, historyTitle, team, variant = 'default' }: StandardPageProps) {
    ...
    const renderHero = () => (
        <section className="aspect-[16/9] md:aspect-auto md:h-screen bg-zinc-900 relative flex items-center p-6 md:p-20 pt-32 md:pt-28 overflow-hidden">
            ...
            <div className="absolute inset-0 z-10 w-full h-full">
                {video ? (
                    ...
                    <img
                        src={image}
                        className="w-full h-full object-contain object-top pt-32 md:pt-20 bg-zinc-950"
                        alt={title}
                    />
                )}
            </div>
