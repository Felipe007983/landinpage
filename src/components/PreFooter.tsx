    ...
    return (
        <section className="relative py-24 px-6 overflow-hidden bg-zinc-900 border-t border-white/5">
            ...
            <div className="absolute inset-0 z-0">
                <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-amber-500/10 rounded-full blur-[120px] -mr-32 -mt-32" />
            ...
            <div className="container mx-auto relative z-10 text-center">
                <h2 className="text-4xl md:text-5xl font-black text-white mb-6 tracking-tight uppercase">
                    Eleve seu <span className="text-amber-500">Nível</span>
                </h2>
                ...
                <a
                    ...
                    className="inline-flex items-center gap-3 bg-white text-black px-10 py-5 rounded-full font-bold text-lg uppercase tracking-wider hover:bg-amber-500 hover:text-white transition-all duration-300 shadow-[0_0_30px_rgba(255,255,255,0.2)] hover:shadow-[0_0_50px_rgba(212,175,55,0.4)] transform hover:-translate-y-1"
                >
